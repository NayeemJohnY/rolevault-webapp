...
export default function MyRequests() {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6" data-testid="my-requests">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">My Requests</h1>

            {requests.length === 0 ? (
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">You have not submitted any requests yet.</div>
            ) : (
